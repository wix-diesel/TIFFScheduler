...
export function compareScores(a: ScheduleScore, b: ScheduleScore): number {
  return a.missedFilmCount - b.missedFilmCount || a.vacationDays - b.vacationDays || a.travelMinutes - b.travelMinutes || a.waitingMinutes - b.waitingMinutes;
}
export function scorePlan(screenings: Screening[], lunches: LunchBreak[], input: ScheduleInput): SchedulePlan {
  ...
  return { screenings: [...screenings], missedFilmIds, vacationDates, lunches, score: { missedFilmCount: missedFilmIds.length, vacationDays: vacationDates.length, travelMinutes: travel, waitingMinutes: waiting } };
}
