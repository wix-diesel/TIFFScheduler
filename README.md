...
現在は **Phase 4: Deployment** の公開ワークフローとブラウザテストまで実装済みです。2025年の公式データ（149作品・282上映・13会場）で、作品検索・選択、1日最大鑑賞本数・上映開始下限を含む条件設定、最大3案の生成、日別タイムライン、設定の自動復元、名前付きプラン保存を利用できます。
